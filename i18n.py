...
T = {
    "en": {
        ...
        "api.local_only": "This only works when running Runcast locally.",
        "api.no_self_vote": "You can't vote on your own collection",
        "api.bad_vote": "Invalid vote value",
        ...
        "coll.added": "Added",
        "coll.view": "Open",
        "coll.private_badge": "Private",
        "coll.shared_badge": "Shared",
        "coll.share_button": "Share…",
        "coll.unshare_button": "Stop sharing",
        "coll.description_placeholder": "Short description (optional)",
        "coll.share_save": "Save & share",
        "coll.private_note": "Private — only you can see this.",
        "coll.shared_note": "Shared — anyone with the link can view.",
        "coll.private_owner_note": "This collection is private — you're the only one who can see this page.",
        "coll.delete_button": "Delete",
        "coll.like": "Like",
        "coll.dislike": "Dislike",
        "coll.login_to_vote": "Log in to like or dislike",
        "coll.own_collection": "This is your collection",
        "shared.nav": "Shared collections",
        "shared.title": "Shared collections",
        "shared.subtitle": "Collections other Runcast users have made public.",
        "shared.empty": "No collections have been shared yet.",
        "shared.sort_recent": "Newest",
        "shared.sort_popular": "Most liked",
        "shared.view": "Open →",
    },
    "ko": {
        ...
        "api.local_only": "이 기능은 Runcast를 로컬에서 직접 실행할 때만 동작합니다.",
        "api.no_self_vote": "본인 모음집에는 투표할 수 없습니다",
        "api.bad_vote": "잘못된 투표 값입니다",
        ...
        "coll.added": "추가됨",
        "coll.view": "열기",
        "coll.private_badge": "비공개",
        "coll.shared_badge": "공유 중",
        "coll.share_button": "공유하기…",
        "coll.unshare_button": "공유 중지",
        "coll.description_placeholder": "소개 문구 (선택)",
        "coll.share_save": "저장하고 공유",
        "coll.private_note": "비공개 — 본인만 볼 수 있어요.",
        "coll.shared_note": "공유 중 — 링크가 있으면 누구나 볼 수 있어요.",
        "coll.private_owner_note": "지금은 비공개 상태입니다 — 본인만 이 페이지를 볼 수 있어요.",
        "coll.delete_button": "삭제",
        "coll.like": "좋아요",
        "coll.dislike": "싫어요",
        "coll.login_to_vote": "로그인하면 좋아요/싫어요를 누를 수 있어요",
        "coll.own_collection": "본인이 만든 모음집입니다",
        "shared.nav": "공유 모음집",
        "shared.title": "공유 모음집",
        "shared.subtitle": "다른 Runcast 사용자들이 공개한 모음집입니다.",
        "shared.empty": "아직 공유된 모음집이 없습니다.",
        "shared.sort_recent": "최신순",
        "shared.sort_popular": "좋아요순",
        "shared.view": "열기 →",
    },
}
